<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <x-nav-link :href="route('evenements.reservations_statistics')" :active="request()->routeIs('evenements.reservations_statistics')">
        {{ __('Event Statistics') }}
    </x-nav-link>
@endrole
...
@endrole
    ...
    <!-- Settings Dropdown -->
    <!-- Include your settings dropdown code here -->
</div>
